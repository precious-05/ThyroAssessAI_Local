...
function initializeImageSlider() {
    ...
    if (imageSlider) {
        const swiper = new Swiper('.image-slider', {
            ...
            loop: true,
            speed: 1000, // Slower transition for better visibility
            
            // Autoplay settings - FIXED
            autoplay: {
            ...
            // Fade effect (DISABLED - causing disappearance)
        ...
        // Force display all images on load
        setTimeout(() => {
...
function fixImageDisplay() {
    // Add CSS to ensure images stay visible
